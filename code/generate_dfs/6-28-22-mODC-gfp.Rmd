...
```{r}
new.gfpLiveCells %>% 
  write_csv(.,path = "pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/raw_gfp_int_all.csv")
```
...
```{bash}
mkdir -p pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/
```
...
write_csv(cell_atributes_final,file = "pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/6-28-22_mODC_pup1_attributes.csv")
...
write_csv(gfp_mODCPest_filtered , file = "pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/gfp_mODCPest_pup1_filtered.csv")
```
...
```{r}
write_csv(df_for_MechanisticModel , file = "pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/gfp_mODCPest_pup1_raw_data.csv")
```
...
```{r}
read_csv("pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/6-28-22_mODC_pup1_attributes.csv") %>% 
  ...
  write_csv(.,path = "pup1-rfp-gfp-decay/6-28-22-modc-gfp/data/6-28-22_mODC_pup1_attributes.csv")
```
