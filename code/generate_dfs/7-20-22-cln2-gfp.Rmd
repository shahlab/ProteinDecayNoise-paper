...
```{r}
new.gfpLiveCells %>% 
  write_csv(.,path = "~/plots/pup1-rfp-gfp-decay/7-20-22-cln2-gfp/data/raw_gfp_int_all.csv")
```
...
write_csv(cell_atributes_final,file = "/home/Das/plots/pup1-rfp-gfp-decay/7-20-22-cln2-gfp/data/7-20-22_cln2_pup1_attributes.csv")
...
write_csv(gfp_cln2Pest_filtered , file = "~/plots/pup1-rfp-gfp-decay/7-20-22-cln2-gfp/data/gfp_cln2Pest_pup1_filtered.csv")
```
...
```{r}
write_csv(df_for_MechanisticModel , file = "~/plots/pup1-rfp-gfp-decay/7-20-22-cln2-gfp/data/gfp_cln2Pest_pup1_raw_data.csv")
```
