...
```{bash}
mkdir ../../proteasome_inhibition/data/4-1-22/DMSO
```
...
gfp_imaris <- dir("../../Imaris-data-PI/2022/proteasome_inhibition/4-1-22-PI/DMSO/imaris/gfp", full.names = TRUE)

#getting the information for imageJ image info files
#getting all the image info txt for all the images in the experiment. 
list.image.info <- list.files("../../Imaris-data-PI/2022/proteasome_inhibition/4-1-22-PI/DMSO/image_info_imageJ" , full.names = TRUE)
...
```{r}
dapi_pup1_imaris_cells <- dir("../../Imaris-data-PI/2022/proteasome_inhibition/4-1-22-PI/DMSO/imaris/surface/cells", full.names = TRUE) 
...
```{r}
pup1_surface_imaris <- dir("../../Imaris-data-PI/2022/proteasome_inhibition/4-1-22-PI/DMSO/imaris/surface/pup1", full.names = TRUE) 
...
bg <- dir(path = "../../Imaris-data-PI/2022/proteasome_inhibition/4-1-22-PI/DMSO/background" , full.names = TRUE)
...
```{r}
new.gfpLiveCells %>% 
  write_csv(.,path = "../../proteasome_inhibition/data/4-1-22/DMSO/raw_gfp_int_all.csv")
```
...
write_csv(cell_atributes_final,file = "../../proteasome_inhibition/data/4-1-22/DMSO/4-1-22-GFP_mODC_DMSO_attributes.csv")
...
write_csv(gfp_mODCPest_filtered , file = "../../proteasome_inhibition/data/4-1-22/DMSO/gfp_mODCPest_DMSO_filtered.csv")
```
...
```{r}
write_csv(df_for_MechanisticModel , file = "../../proteasome_inhibition/data/4-1-22/DMSO/gfp_mODCPest_DMSO_raw_data.csv")
```
