...
gfp_imaris <- dir("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/imaris/gfp", full.names = TRUE)

#getting the information for imageJ image info files
#getting all the image info txt for all the images in the experiment. 
list.image.info <- list.files("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/image_info_imageJ" , full.names = TRUE)
...
```{r}
dapi_pup1_imaris_cells <- dir("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/imaris/surface/cells", full.names = TRUE) 
...
```{r}
pup1_surface_imaris <- dir("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/imaris/surface/pup1", full.names = TRUE) 
...
bg <- dir(path = "~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/background" , full.names = TRUE)
...
```{r}
s4_s5_s6_bg_rfp.dapi <- list.files("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/background/bg_mcherry_dapi_s4_s5_s6", full.names = T)
...
```{r}
s4_s5_s6_bg_files <- list.files("~/Imaris-data/2022/proteasome_inhibition/4-1-22-PI/1uM/background/bg_gfp_s4_s5_s6", full.names = T)
...
```{r}
new.gfpLiveCells %>% 
  write_csv(.,path = "~/plots/proteasome_inhibition/data/4-1-22/1uM/raw_gfp_int_all.csv")
```
...
write_csv(cell_atributes_final,file = "/home/Das/plots/proteasome_inhibition/data/4-1-22/1uM/4-1-22-GFP_mODC_1uMMG132_attributes.csv")
...
write_csv(gfp_mODCPest_filtered , file = "~/plots/proteasome_inhibition/data/4-1-22/1uM/gfp_mODCPest_1uMMG132_filtered.csv")
```
...
```{r}
write_csv(df_for_MechanisticModel , file = "~/plots/proteasome_inhibition/data/4-1-22/1uM/gfp_mODCPest_1uMMG132_raw_data.csv")
```
