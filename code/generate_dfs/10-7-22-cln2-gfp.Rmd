...
---
---
title: "10-7-22 cln2-gfp pup1-rfp decay"
output: html_notebook
---
...
```{r}
dapi_pup1_imaris_cells <- dir("~/Imaris-data/2022/pup1_rfp/10-7-22/cln2/imaris/surface/cells", full.names = TRUE) 
...
```{r}
pup1_surface_imaris <- dir("~/Imaris-data/2022/pup1_rfp/10-7-22/cln2/imaris/surface/pup1", full.names = TRUE) 
...
write_csv(cell_atributes_final,file = "/home/Das/plots/pup1-rfp-gfp-decay/10-7-22-cln2-gfp/data/10-7-22_cln2_pup1_attributes.csv")
...
write_csv(gfp_cln2Pest_filtered , file = "~/plots/pup1-rfp-gfp-decay/10-7-22-cln2-gfp/data/gfp_cln2Pest_pup1_filtered.csv")
```
...
```{r}
write_csv(df_for_MechanisticModel , file = "~/plots/pup1-rfp-gfp-decay/10-7-22-cln2-gfp/data/gfp_cln2Pest_pup1_raw_data.csv")
```
